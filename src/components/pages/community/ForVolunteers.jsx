    ...
    return (
      <div>
        ...
        <div className = "wrapper2 wrapper">
          ...
          <div className="flexbox1 flexbox">
            ...
            <div className="wrapperTwo-flexbox1-right quote-referal">
                ...
                <div>
                "Never got to join hackathons but it is a eye-opening to me. Glad that I became a volunteer to see what it's like" - Joordin
                </div><br/>
                <div>
        ...
        <div className="flexbox4 flexbox">
            <div className="wrapperTwo-flexbox1-left">Interested? Let's have a chat!</div>
              {/* <div style={{width:20+'px'}}></div> */}
            <div className="wrapperTwo-flexbox1-right">
