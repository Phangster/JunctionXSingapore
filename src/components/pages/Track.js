                        ...
                        <div className = "grid-prize">
                            <div className = "grid-subPrice">
                                ...
                                <div>
                                    ...
                                    <p>$250 worth of Rakuten Rapid API credits</p>
                                    <p className="smallWords">* An opportunity of the life time to fly to Helsinki to hackjunction to participate in the Europe's largest hackathon with 200 Euros reimbursement and free accomodation over the period of the event</p>
                                </div>
                                <div>
                                    <h3 className="textColor">2nd</h3>
                                    <p>$150 worth of Rakuten Rapid API credits</p>
                                </div>
                                <div>
                                    <h3 className="textColor">3rd</h3>
                                    <p>$100 worth of Rakuten Rapid API credits</p>
                                </div>
                            </div>
                            <div className = "grid-subPrice">
