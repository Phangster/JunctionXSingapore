            ...
            <div className = "containerMain blackBackground">
                ...
                <div className = "grid-track">
                    <div className = "gridItem-track">
                        ...
                        <div className = "trackImageContainer"><NavLink to='/rakuten' onClick={this.props.menuToggle}><img className="image1-track" src={ARVR} alt="AR/VR " /></NavLink></div>
                        <p>Augmented Reality and Virtual Reality</p>
                    </div>
                    <div className = "gridItem-track">
                        <img className= "sponsor" src={Shopee} alt="Shopee"/>
                        <div className = "trackImageContainer"><NavLink to='/shopee' onClick={this.props.menuToggle}><img className="image1-track" src={Smartcommerce} alt="Smartcommerce" /></NavLink></div>
                        <p>The future of smart Ecommerce</p>
                    </div>
                    <div>
                        <div className = "gridItem-track">
                            <img className= "sponsor" src={Kaspersky} alt="Kaspersky" />
                            <div className = "trackImageContainer"><NavLink to='/kaspersky' onClick={this.props.menuToggle}><img className="image1-track" src={Security} alt="Security" /></NavLink></div>
