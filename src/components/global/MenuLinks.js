...
class MenuLinks extends Component {
    render() {
        return ( <
            ...
            id = 'menu' >
            <
            Link to = "/" > < img className = "logoSize NavLogo"
            src = { JunctionBlack }
            alt = "JunctionLogo" / > < /Link>

            <
            Link to = "/" > < p className = 'header-css'
            onClick = { this.props.menuToggle } > Home < /p></Link >
            <
            ul >
            <
            li > < Link to = "/OurStory"
            onClick = { this.props.menuToggle } > Our Story < /Link></li >
            <
            li > < Link to = "/Calendar"
            onClick = { this.props.menuToggle } > Calendar < /Link></li >
            ...
            <
            li > < Link to = "/Team"
            onClick = { this.props.menuToggle } > 2020 Team < /Link></li >
            <
            li > < Link to = "/Team2019"
            onClick = { this.props.menuToggle } > 2019 Team < /Link></li >
            <
            /ul>
            ...
            ul >
            <
            li > < Link to = "/JunctionxAsia2020"
            onClick = { this.props.menuToggle } > JunctionX Asia 2020 < /Link></li >
            <
            li > < Link to = "/JunctionxSingapore2019"
            onClick = { this.props.menuToggle } > JunctionX Singapore 2019 < /Link></li >
            ...
            ul >
            <
            li > < Link to = "/OurPartners"
            onClick = { this.props.menuToggle } > Our Partners < /Link></li >
            <
            li > < Link to = "/ForPartners"
            onClick = { this.props.menuToggle } > For Partners < /Link></li >
            <
            li > < Link to = "/ForParticipants"
            onClick = { this.props.menuToggle } > For Participants < /Link></li >
            <
            li > < Link to = "/ForVolunteers"
            onClick = { this.props.menuToggle } > For Volunteers < /Link></li >
            <
            /ul>
            ...
            onClick = { this.props.menuToggle } > Contact Us < /Link></li > { /* <li><Link to="/gallery" onClick={this.props.menuToggle}>Gallery</Link></li> */ } <
            /ul> <
            /div>
        )
    }
